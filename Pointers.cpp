...
using namespace std;
/* POINTERS ARE ordinary variables that can store address of variable */
int main()
{
    int var = 5;
    int a = 20;
    ...
    int *p = &var; // that asterisk here is just used to INFORM about that this variable is a POINTER so its is a variable that can point to the address of another variable.

    // p = &var;

    cout << *p << endl; // that asterisk here is used to RETRIEVE (GET) value FROM indicated (pointed) area in out memory (address)
    ...
    *p = 60;
    ...
    cout << "&ordinary_var: " << &ordinary_var << endl; // address of integer value
